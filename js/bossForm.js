...
function bossFormFunctions(){
	// Show world boss fields if world boss is selected
	if(worldBoss){
	...
	$("#addPowerBtn").on("click", function(e){
		...
		newTxt.classList.add('browser-default');
		newTxt.type = 'text';
	...
	$("#generate").on("click", function(e){
		...
		var blob = new Blob([yml], {type: 'text/csv'});
